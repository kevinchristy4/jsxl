...
// TODO how do we type check Functional return values ?		
		...
		'$inc+$ninc':					{ $optional: true, $type: null }, 								// assertions, all items are related in a lean way, possibly matching if RegExp is provided, if function, then to be executed at runtime time with parameters // $any: [ Function, Boolean, Number, String, RegExp, Date ] 
		$match:							{ $optional: true, $type: null }, 								// assertion, item is mattched, if function, then to be executed at runtime time with parameters // $any: [ Function, String, RegExp ] 
