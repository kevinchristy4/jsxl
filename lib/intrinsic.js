'use strict';
// jsxl-filters compiled with jsxl-filters on Fri Jul 16 2021 01:09:35 GMT+0530 (India Standard Time)
...
Object.assign(filter, { "Type1{}":
	function(context, functions, renamed, next) { // v1, key: Type1{}, timestamp: 1626377975381
...
filter["Type1{}"].timestamp = 1626377975381;
filter["Type1{}"].compiler  = "v1";

Object.assign(filter, { "Shell1{}":
	function(context, functions, renamed, next) { // v1, key: Shell1{}, timestamp: 1626377975373
		const source = context.source, target = context.target, key = context.key;
		async.waterfall([
			next => {
				if (source[key] === undefined) return utils.mustBeProvided(context, next);
...
filter["Shell1{}"].timestamp = 1626377975373;
filter["Shell1{}"].compiler  = "v1";

Object.assign(filter, { "Type1{$optional:true}":
	function(context, functions, renamed, next) { // v1, key: Type1{$optional:true}, timestamp: 1626377975376
		const source = context.source, target = context.target, key = context.key;
		async.series([ // any all
			next => (next => { // any option 
				async.waterfall([
...
filter["Type1{$optional:true}"].timestamp = 1626377975376;
filter["Type1{$optional:true}"].compiler  = "v1";

Object.assign(filter, { "Object1{}":
	function(context, functions, renamed, next) { // v1, key: Object1{}, timestamp: 1626377975407
		const source = context.source, target = context.target, key = context.key;
		async.waterfall([
			next => {
				if (source[key] === undefined) return utils.mustBeProvided(context, next);
...
filter["Object1{}"].timestamp = 1626377975407;
filter["Object1{}"].compiler  = "v1";

Object.assign(filter, { "Array1{}":
	function(context, functions, renamed, next) { // v1, key: Array1{}, timestamp: 1626377975408
		const source = context.source, target = context.target, key = context.key;
		async.series([ // functions
			next => { // filter
...
filter["Array1{}"].timestamp = 1626377975408;
filter["Array1{}"].compiler  = "v1";

Object.assign(filter, { "type1":
	function(context, functions, renamed, next) { // v1, key: type1, timestamp: 1626377975369
		const source = context.source, target = context.target, key = context.key;
		utils.intrinsic.filter["Type1{}"](context, utils.intrinsic.filter["Type1{}"].functions, renamed, next);
	}
});
filter["type1"].functions = [];
filter["type1"].timestamp = 1626377975369;
filter["type1"].compiler  = "v1";
...
Object.assign(filter, { "Type2{}":
	function(context, functions, renamed, next) { // v2, key: Type2{}, timestamp: 1626377975510
		const source = context.source, target = context.target, key = context.key;
		async.series([ // functions
			next => { // filter
...
filter["Type2{}"].timestamp = 1626377975510;
filter["Type2{}"].compiler  = "v2";

Object.assign(filter, { "Shell2{}":
	function(context, functions, renamed, next) { // v2, key: Shell2{}, timestamp: 1626377975513
		const source = context.source, target = context.target, key = context.key;
		async.waterfall([
			next => {
				if (source[key] === undefined) return utils.mustBeProvided(context, next);
...
filter["Shell2{}"].timestamp = 1626377975513;
filter["Shell2{}"].compiler  = "v2";

Object.assign(filter, { "Type2{$optional:true}":
	function(context, functions, renamed, next) { // v2, key: Type2{$optional:true}, timestamp: 1626377975514
		const source = context.source, target = context.target, key = context.key;
		async.series([ // functions
			next => { // filter
				utils.callFilter(context, functions[13], (err, keep) => { if (err) return next(err);
...
filter["Type2{$optional:true}"].timestamp = 1626377975514;
filter["Type2{$optional:true}"].compiler  = "v2";

Object.assign(filter, { "Shell2{$optional:true}":
	function(context, functions, renamed, next) { // v2, key: Shell2{$optional:true}, timestamp: 1626377975515
		const source = context.source, target = context.target, key = context.key;
		async.waterfall([
			next => {
				if (source[key] === undefined) return utils.mustBeProvided(context, next);
...
filter["Shell2{$optional:true}"].timestamp = 1626377975515;
filter["Shell2{$optional:true}"].compiler  = "v2";

Object.assign(filter, { "type2":
	function(context, functions, renamed, next) { // v2, key: type2, timestamp: 1626377975509
		const source = context.source, target = context.target, key = context.key;
		utils.intrinsic.filter["Type2{}"](context, utils.intrinsic.filter["Type2{}"].functions, renamed, next);
	}
});
filter["type2"].functions = [];
filter["type2"].timestamp = 1626377975509;
filter["type2"].compiler  = "v2";

module.exports.timestamp = 1626377975548;
