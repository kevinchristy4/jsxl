...
describe('Filter modifier tests',()=>{
    ...
    it(`Pass true or false to $filters at different levels`,()=>{
        ...
        // Setting a $filter at top level as false returns undefined.
        //Fixed
        jsxlFunction.verifyResult('Pass false in $filter at the top level of an object',jsxlFunction.jsxlDirect(input.filterTrue,filter.filterFalseAtTop),'pass','undefined');
