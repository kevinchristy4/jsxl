...
describe('ToArray Modofoer test',()=>{
    ...
    it('Verify output with proper input and filter at different levels',()=>{
        ...
        //Calling $toArray at top level and also converting deper level object to Array - Object key and value is directly appended to the output.
        // jsxlFunction.verifyResult('Use $toArray at top level',jsxlFunction.jsxlDirect(input.toArrInput,filter.toArrayAtTop),'pass',"TBD");
    ...
    it('Object with value of key not of object',()=>{
        ...
        // jsxlFunction.verifyResult('Use with incompatible objects pattern',jsxlFunction.jsxlDirect(input.toArrInputIncompatible,filter.toArrayPass),'pass','TBD');
